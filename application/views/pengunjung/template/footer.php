<footer class="footer">
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="d-flex justify-content-between align-items-center">
						<div class="d-flex align-items-center">
							<img src="<?php echo base_url(); ?>assets/fe/images/logo.svg" alt="logo" class="mr-3">
		...
		<script src="<?php echo base_url(); ?>assets/fe/vendors/base/vendor.bundle.base.js"></script>
		<script src="<?php echo base_url(); ?>assets/fe/vendors/owl.carousel/js/owl.carousel.js"></script>
		<script src="<?php echo base_url(); ?>assets/fe/vendors/aos/js/aos.js"></script>
		<script src="<?php echo base_url(); ?>assets/fe/vendors/jquery-flipster/js/jquery.flipster.min.js"></script>
		<script src="<?php echo base_url(); ?>assets/fe/js/template.js"></script>
	</body>
</html>