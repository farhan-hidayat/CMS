							...
							<div class="main-banner">
								<div class="d-sm-flex justify-content-between">
									...
									<div class="mt-5 mt-lg-0">
										<img src="<?php echo base_url(); ?>assets/fe/images/group.png" alt="marsmello" class="img-fluid" data-aos="zoom-in-up">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="<?php echo base_url(); ?>assets/fe/images/integrated-marketing.svg" alt="integrated-marketing" data-aos="zoom-in">
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box"   data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="<?php echo base_url(); ?>assets/fe/images/design-development.svg" alt="design-development" data-aos="zoom-in">
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="<?php echo base_url(); ?>assets/fe/images/digital-strategy.svg" alt="digital-strategy" data-aos="zoom-in">
					...
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box  pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="<?php echo base_url(); ?>assets/fe/images/digital-marketing.svg" alt="digital-marketing" data-aos="zoom-in">
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Digital 
									Marketing
								</h6>
								<p>Lorem ipsum dolor sit amet, 
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="<?php echo base_url(); ?>assets/fe/images/growth-strategy.svg" alt="growth-strategy" data-aos="zoom-in">
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box pb-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								<img src="<?php echo base_url(); ?>assets/fe/images/saving-strategy.svg" alt="saving-strategy" data-aos="zoom-in">
					...
					<div class="row">
						<div class="col-sm-6" data-aos="fade-up">
							...
							<div class="d-flex justify-content-start mb-3">
								<img src="<?php echo base_url(); ?>assets/fe/images/tick.png" alt="tick" class="mr-3 tick-icon"  >
						...
						<div class="col-sm-6 text-right" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
							<img src="<?php echo base_url(); ?>assets/fe/images/idea.png" alt="idea" class="img-fluid">
						</div>
					</div>
				</div>
			</section>
			<section class="our-projects" id="projects">
				...
				<div class="mb-5" data-aos="fade-up">
					<div class="owl-carousel-projects owl-carousel owl-theme">
						<div class="item">
							<img src="<?php echo base_url(); ?>assets/fe/images/carousel/slider1.jpg" alt="slider">
						</div>
						<div class="item">
							<img src="<?php echo base_url(); ?>assets/fe/images/carousel/slider2.jpg" alt="slider">
						</div>
						<div class="item">
							<img src="<?php echo base_url(); ?>assets/fe/images/carousel/slider3.jpg" alt="slider">
						</div>
						<div class="item">
							<img src="<?php echo base_url(); ?>assets/fe/images/carousel/slider4.jpg" alt="slider">
						</div>
						<div class="item">
							<img src="<?php echo base_url(); ?>assets/fe/images/carousel/slider5.jpg" alt="slider">
						</div>
						<div class="item">
							<img src="<?php echo base_url(); ?>assets/fe/images/carousel/slider1.jpg" alt="slider">
						</div>
					...
					<div class="row pt-5 mt-5 pb-5 mb-5">
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-down">
								<img src="<?php echo base_url(); ?>assets/fe/images/satisfied-client.svg" alt="satisfied-client" class="mr-3">
								<div>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-up">
								<img src="<?php echo base_url(); ?>assets/fe/images/finished-project.svg" alt="satisfied-client" class="mr-3">
								<div>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-down">
								<img src="<?php echo base_url(); ?>assets/fe/images/team-members.svg" alt="Team Members" class="mr-3">
								<div>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-up">
								<img src="<?php echo base_url(); ?>assets/fe/images/our-blog-posts.svg" alt="Our Blog Posts" class="mr-3">
								<div>
								...
								<ul>
									<li>
										<div class="testimonial-item">
											<img src="<?php echo base_url(); ?>assets/fe/images/testimonial/testimonial1.jpg" alt="icon" class="testimonial-icons">
									...
									<li>
										<div class="testimonial-item">
											<img src="<?php echo base_url(); ?>assets/fe/images/testimonial/testimonial2.jpg" alt="icon" class="testimonial-icons">
											<p>Lorem ipsum dolor sit amet, consectetur
												pretium pretium tempor.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pretium
											</p>
									...
									<li>
										<div class="testimonial-item">
											<img src="<?php echo base_url(); ?>assets/fe/images/testimonial/testimonial3.jpg" alt="icon" class="testimonial-icons">
											<p>Lorem ipsum dolor sit amet, consectetur
												pretium pretium tempor.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pretium
											</p>
									...
									<li>
										<div class="testimonial-item">
											<img src="<?php echo base_url(); ?>assets/fe/images/testimonial/testimonial4.jpg" alt="icon" class="testimonial-icons">
											<p>Lorem ipsum dolor sit amet, consectetur
												pretium pretium tempor.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pretium
											</p>
											<h6 class="testimonial-author">Mark Spenser</h6>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="d-sm-flex justify-content-between align-items-center">
								<img src="<?php echo base_url(); ?>assets/fe/images/deloit.svg" alt="deloit" class="p-2 p-lg-0" data-aos="fade-down"  data-aos-offset="-400">
								<img src="<?php echo base_url(); ?>assets/fe/images/erricson.svg" alt="erricson" class="p-2 p-lg-0" data-aos="fade-up"  data-aos-offset="-400">
								<img src="<?php echo base_url(); ?>assets/fe/images/netflix.svg" alt="netflix" class="p-2 p-lg-0" data-aos="fade-down"  data-aos-offset="-400">
								<img src="<?php echo base_url(); ?>assets/fe/images/instagram.svg" alt="instagram" class="p-2 p-lg-0" data-aos="fade-up"  data-aos-offset="-400">
								<img src="<?php echo base_url(); ?>assets/fe/images/coinbase.svg" alt="coinbase" class="p-2 p-lg-0" data-aos="fade-down"  data-aos-offset="-400">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row"  data-aos="fade-up" data-aos-offset="-300">
						<div class="col-sm-4">
							<div class="pricing-box">
								<img src="<?php echo base_url(); ?>assets/fe/images/starter.svg" alt="starter">
						...
						<div class="col-sm-4">
							<div class="pricing-box selected">
								<img src="<?php echo base_url(); ?>assets/fe/images/proffessional.svg" alt="starter">
						...
						<div class="col-sm-4">
							<div class="pricing-box">
								<img src="<?php echo base_url(); ?>assets/fe/images/premium.svg" alt="starter">
				...
				<div class="container">
					<div class="row mb-5 pb-5">
						<div class="col-sm-5" data-aos="fade-up" data-aos-offset="-500">
							<img src="<?php echo base_url(); ?>assets/fe/images/contact.jpg" alt="contact" class="img-fluid">
						</div>
